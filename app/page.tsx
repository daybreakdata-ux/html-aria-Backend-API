...
import { AppHeader } from "@/components/aria-home/app-header"
import { SearchBar } from "@/components/aria-home/search-bar"
import { FeatureButtons } from "@/components/aria-home/feature-buttons"
import { WeatherWidget } from "@/components/aria-home/weather-widget"
import { NewsFeed } from "@/components/aria-home/news-feed"
import { InstallPrompt } from "@/components/aria-home/install-prompt"
...
export default function HomePage() {
  ...
  if (status === 'loading') {
    return (
      <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-gradient-to-b from-slate-900 via-slate-800 to-slate-950">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center space-y-8 px-6 text-center">
          <div className="relative">
            ...
            <SpinningGlobe className="h-32 w-32 shadow-2xl shadow-sky-500/50" />
          </div>
  ...
  // Show sign-in/sign-up screen for unauthenticated users
  if (status === 'unauthenticated') {
    return (
      <div className="relative min-h-screen overflow-hidden bg-gradient-to-b from-slate-900 via-slate-800 to-slate-950">
  ...
  return (
    <div className="h-[100dvh] bg-gradient-to-r from-slate-100 to-slate-200 dark:from-slate-500 dark:to-slate-800 flex flex-col">
      <AppHeader />
