...
import { Menu, Send, Settings, Plus, X, Copy, RotateCw, Globe, Sparkles, Download, Mic, Paperclip, History, Zap, LogOut, MoreHorizontal, Home } from "lucide-react"
                      ...
                      <DropdownMenu>
                        <DropdownMenuTrigger asChild>
                          <Button
                            size="sm"
                            variant="ghost"
                            className="h-6 w-6 p-0 opacity-60 hover:opacity-100 text-black"
                          >
              ...
              <div className="flex-1 relative bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl border border-gray-200 dark:border-gray-700 rounded-3xl shadow-2xl p-1">
                <div className="flex items-end gap-2 p-2">
                  ...
                  <Button
                    ...
                    className="h-10 w-10 rounded-2xl p-0 flex-shrink-0 border-2 border-dashed dark:border-white dark:text-white dark:hover:bg-white/5 border-black text-black bg-transparent hover:bg-black/5 transition-colors"
                  >
